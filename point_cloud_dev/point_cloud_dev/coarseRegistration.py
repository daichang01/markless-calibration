...
# 应用 PCA 进行配准
transformation1,trans1 = apply_pca(pc1)
transformation2,trans2 = apply_pca(pc2)
...
pc3_aligned.paint_uniform_color([1, 1, 0])  # 红色表示源点云
pc4_aligned.paint_uniform_color([0, 1, 1])  # 绿色表示目标点云
